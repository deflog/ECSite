...
<html>
    ...
    <form action="Myupdate" method="POST" style="margin:0px; float:left;">
        <input type="hidden" name="ac" value="<%=hs.getAttribute("ac")%>">
        <button type="submit" class="btn btn-primary">UpdateMydata</button>
    </form>
    <form action="Myhistroy" method="POST"style="margin:0px; float:left;">
        <input type="hidden" name="ac" value="<%=hs.getAttribute("ac")%>">
        <button  type="submit" class="btn btn-info">Myhistroy</button>
    </form>
    <form action="Mydelete" method="POST">
        <input type="hidden" name="ac" value="<%=hs.getAttribute("ac")%>">
        <button type="submit" class="btn btn-danger">DeleteMydata</button>
    </form>
